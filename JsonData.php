...
$wgJsonDataDefaultTagHandlers = [ 'json', 'jsonschema' ];
...
$wgJsonDataConfig = [ 'srctype' => 'predefined', 'src' => 'configexample' ];

$wgResourceModules['ext.jsonwidget'] = [
	'scripts' => [
		'json.js',
		'jsonedit.js',
		'mw.jsondata.js'
